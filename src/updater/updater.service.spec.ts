...
describe('UpdaterService realtime gating', () => {
  ...
  function makeService(env: Record<string, string | undefined>, deployments: Deployment[]): UpdaterService {
    ...
    return new UpdaterService(
      ...
      noop, // gradientRealtimeService
      noop, // gradientStrategyCreatedEventService
      noop, // gradientStrategyUpdatedEventService
      noop, // gradientStrategyDeletedEventService
      noop, // gradientPairCreatedEventService
      noop, // gradientTokensTradedEventService
      noop, // gradientTradingFeePPMEventService
      noop, // gradientPairTradingFeePPMEventService
      noop, // gradientStrategyLiquidityUpdatedEventService
      noop, // gradientVoucherTransferEventService
      noop, // gradientActivityService
      noop, // gradientDexScreenerService
      noop, // gradientStrategyService
      redis,
    );
  }
