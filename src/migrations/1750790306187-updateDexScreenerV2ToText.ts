...
export class UpdateDexScreenerV2ToText1750790306187 implements MigrationInterface {
    name = 'UpdateDexScreenerV2ToText1750790306187'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dex-screener-events-v2" DROP COLUMN "eventIndex"`);
        await queryRunner.query(`ALTER TABLE "dex-screener-events-v2" ADD "eventIndex" text NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dex-screener-events-v2" DROP COLUMN "eventIndex"`);
        await queryRunner.query(`ALTER TABLE "dex-screener-events-v2" ADD "eventIndex" numeric(10,1) NOT NULL`);
