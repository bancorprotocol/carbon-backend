...
export class AddMerklRewards1752511918076 implements MigrationInterface {
  name = 'AddMerklRewards1752511918076';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "merkl_campaigns" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "pairId" integer NOT NULL, "rewardAmount" numeric(78,0) NOT NULL, "rewardTokenAddress" character varying NOT NULL, "startDate" integer NOT NULL, "endDate" integer NOT NULL, "opportunityName" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_96b1f67f2675941e0531a432c2a" UNIQUE ("blockchainType", "exchangeId", "pairId"), CONSTRAINT "PK_daf9aa4f8dd1409ae27b3d43a5f" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "merkl_epoch_rewards" ("id" SERIAL NOT NULL, "campaignId" integer NOT NULL, "epochNumber" integer NOT NULL, "epochStartTimestamp" integer NOT NULL, "epochEndTimestamp" integer NOT NULL, "strategyId" character varying NOT NULL, "owner" character varying NOT NULL, "rewardAmount" numeric(78,0) NOT NULL, "reason" character varying NOT NULL, "calculatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_16f6feee67daee190fcff5a7c41" UNIQUE ("campaignId", "epochNumber", "strategyId"), CONSTRAINT "PK_7a40369cab7ecacfab89ce7c8cf" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "merkl_campaigns" ADD CONSTRAINT "FK_658bfd23e37e5a35201fffc2fc3" FOREIGN KEY ("pairId") REFERENCES "pairs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "merkl_epoch_rewards" ADD CONSTRAINT "FK_225a702fd655b987b07d186ddf8" FOREIGN KEY ("campaignId") REFERENCES "merkl_campaigns"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
