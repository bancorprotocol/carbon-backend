...
export class VolumeRefactor1725977797719 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."volume_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        await queryRunner.query(`ALTER TABLE "volume" ADD "blockchainType" "public"."volume_blockchaintype_enum" NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."volume_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`ALTER TABLE "volume" ADD CONSTRAINT "PK_e97dc8e2b9df850fcb223ed6174" PRIMARY KEY ("id", "timestamp")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_796a52b2eb7472206c0fe9d62d" ON "volume" ("feeAddress", "blockchainType", "exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_5231f9fa521998b7fb45c582ad" ON "volume" ("targetAddress", "blockchainType", "exchangeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a637489965565d258cae2283b4" ON "volume" ("pairId", "blockchainType", "exchangeId") `);
        await queryRunner.query(`ALTER TABLE "volume" ADD CONSTRAINT "UQ_25d27c92dd0baa9b519f62d62b7" UNIQUE ("blockchainType", "exchangeId", "timestamp", "blockNumber", "transactionIndex", "feeSymbol", "feeAddress", "tradingFeeAmountReal", "tradingFeeAmountUsd", "targetSymbol", "targetAddress", "targetAmountReal", "targetAmountUsd")`);
    }
