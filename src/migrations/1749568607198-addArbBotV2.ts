...
export class AddArbBotV21749568607198 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_305edd238bdbdc22f483f53e00" ON "arbitrage-executed-events-v2" ("blockchainType") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ba60cbae3db2913ffa32fe5630" ON "arbitrage-executed-events-v2" ("exchangeId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d13afc933d8a97b1b479d92246" ON "arbitrage-executed-events-v2" ("blockId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5a72d81b80f000394222290e26" ON "arbitrage-executed-events-v2" ("caller") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f5088b239b8cfc08239c8b107b" ON "arbitrage-executed-events-v2" ("timestamp") `,
    );
    await queryRunner.query(
      `ALTER TABLE "arbitrage-executed-events-v2" ADD CONSTRAINT "FK_d13afc933d8a97b1b479d922464" FOREIGN KEY ("blockId") REFERENCES "blocks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "arbitrage-executed-events-v2" DROP CONSTRAINT "FK_d13afc933d8a97b1b479d922464"`,
    );
