...
export class AddBancorArbitrage1733233111128 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."arbitrage-executed-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."arbitrage-executed-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast')`,
    );
    await queryRunner.query(
