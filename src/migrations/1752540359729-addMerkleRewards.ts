...
export class AddMerkleRewards1752540359729 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "merkl_campaigns" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "pairId" integer NOT NULL, "rewardAmount" numeric(78,0) NOT NULL, "rewardTokenAddress" character varying NOT NULL, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "opportunityName" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_daf9aa4f8dd1409ae27b3d43a5f" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "merkl_epoch_rewards" ("id" SERIAL NOT NULL, "blockchainType" character varying NOT NULL, "exchangeId" character varying NOT NULL, "campaignId" integer NOT NULL, "epochNumber" integer NOT NULL, "epochStartTimestamp" TIMESTAMP NOT NULL, "epochEndTimestamp" TIMESTAMP NOT NULL, "strategyId" character varying NOT NULL, "owner" character varying NOT NULL, "rewardAmount" text NOT NULL, "reason" character varying NOT NULL, "calculatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_6517283043faeb80518c3ab00e7" UNIQUE ("blockchainType", "exchangeId", "campaignId", "epochNumber", "strategyId"), CONSTRAINT "PK_7a40369cab7ecacfab89ce7c8cf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_119f7b05a3aa4791ed40b0b203" ON "merkl_epoch_rewards" ("blockchainType") `,
    );
