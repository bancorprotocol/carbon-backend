...
def parse(obj: any) -> any:
    return {
        'CASH': {
            ...
            'min_bid'           : format(obj['simulation recorder']['min bid'        ]),
            'bid_upper_bound'   : format(obj['simulation recorder']['bid upper bound']),
        ...
        'RISK': {
            ...
            'max_ask'           : format(obj['simulation recorder']['max ask'        ]),
            'ask_lower_bound'   : format(obj['simulation recorder']['ask lower bound']),
