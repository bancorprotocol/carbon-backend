...
import { closeExternalDb } from './db';
import { CliArgs, ProbeResult, Verdict } from './types';
...
Usage: npm run qa:compare-staging-prod -- [options]
       (or: ts-node src/scripts/qa-compare/staging-vs-prod.ts [options])
