...
Usage:
  npm run rewards:prepare-audit-data -- --campaign-id <id> [--output-dir <path>]
...
Examples:
  npm run rewards:prepare-audit-data -- --campaign-id 43
  npm run rewards:prepare-audit-data -- --campaign-id 43 --output-dir ../rewards-auditor/data
`);
}
