 ...
 *
 * Usage:
 *   npm run gradient:test:verify
 *   npm run gradient:test:verify -- --mode=layer2
 *   npm run gradient:test:verify -- --base-url=http://localhost:3001
 *   (or: npx ts-node src/scripts/gradient/test-verify.ts [...])
 */
